                ...
                <div className="card-body">
                    <div className="row">
                        <div className="col-lg-12 col-xl-5  mb-4 mt-xl-0">
                            <img src="/src/assets/dashboard/images/layouts/dish-detail/01.png" className="img-fluid rounded" alt="image" style={{height:"100%"}} />
                        </div>
                        <div className="col-lg-12 col-xl-7">
                                ...
                                <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-2 g-lg-3">
                                    <div className="col">
                                        <div className="d-flex align-items-center">
                                            <img src="/src/assets/dashboard/images/layouts/dish-detail/02.png" className="img-fluid avatar-48" alt="image"/>
                                            <div className="ms-3">
                                    ...
                                    <div className="col">
                                        <div className="d-flex align-items-center">
                                            <img src="/src/assets/dashboard/images/layouts/dish-detail/03.png" className="img-fluid avatar-48" alt="image"/>
                                            <div className="ms-3">
                                    ...
                                    <div className="col">
                                        <div className="d-flex align-items-center">
                                            <img src="/src/assets/dashboard/images/layouts/dish-detail/04.png" className="img-fluid avatar-48" alt="image"/>
                                            <div className="ms-3">
                                    ...
                                    <div className="col">
                                        <div className="d-flex align-items-center">
                                            <img src="/src/assets/dashboard/images/layouts/dish-detail/05.png" className="img-fluid avatar-48" alt="image"/>
                                            <div className="ms-3">
                            ...
                            <button type="button" className="btn btn-primary rounded mb-4">View of Ingridients</button>
                            <div className="mb-0">
                            ...
                            <div className="d-flex align-items-center">
                                <button type="button" className="btn btn-primary rounded me-3">View of Ingridients</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="d-flex align-items-center justify-content-between mt-5">
                        <a href="#" className="btn btn-primary rounded">Edit</a>
                        <a href="#" className="btn btn-primary rounded">Delete</a>
                    </div>
                </div>
            </div>
        </div>
               ...
               <div className="card-header bg-transparent">
                  <div className="d-flex justify-content-between align-items-center flex-wrap">
                     ...
                     <div className="d-flex">
                        <a href="#" className="text-dark heading-title">View All
            ...
            <div className="card">
                ...
                <div className="card-body text-dark py-4">
                    ...
                    <div className="d-flex align-items-center justify-content-center">
                         <button type="button" className="btn btn-primary  rounded-pill me-4">Total $200</button>
                          <button type="button" className="btn btn-primary  rounded-pill ms-4">Add To Cart</button>
                    </div>
                </div>
            </div>
        </div>
