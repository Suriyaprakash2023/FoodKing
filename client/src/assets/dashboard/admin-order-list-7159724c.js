...
import { f as k } from "./index-a4e39586.js";
var f = F;
function F() {
  ...
  var t = n[0];
  if (g(t)) throw new Error("extendee must be an object");
...
let z = {
  ...
  fallback() {
    ...
    n ||
      ((n = a.createElement('<div class="dz-message"><span></span></div>')),
  ...
  resize(n, e, t, i) {
    let s = { srcX: 0, srcY: 0, srcWidth: n.width, srcHeight: n.height },
      l = n.width / n.height;
    e == null && t == null
      ? ((e = s.srcWidth), (t = s.srcHeight))
      : e == null
      ? (e = t * l)
      : t == null && (t = e / l),
      (e = Math.min(e, s.srcWidth)),
      (t = Math.min(t, s.srcHeight));
    let r = e / t;
    if (s.srcWidth > e || s.srcHeight > t)
      if (i === "crop")
        l > r
          ? ((s.srcHeight = n.height), (s.srcWidth = s.srcHeight * r))
          : ((s.srcWidth = n.width), (s.srcHeight = s.srcWidth / r));
      else if (i === "contain") l > r ? (t = e / l) : (e = t * l);
      else throw new Error(`Unknown resizeMethod '${i}'`);
    return (
      (s.srcX = (n.width - s.srcWidth) / 2),
      (s.srcY = (n.height - s.srcHeight) / 2),
      (s.trgWidth = e),
      (s.trgHeight = t),
      s
    );
  ...
  addedfile(n) {
    if (
      ...
      (n.previewElement = a.createElement(this.options.previewTemplate.trim())),
        (n.previewTemplate = n.previewElement),
        this.previewsContainer.appendChild(n.previewElement);
      for (var e of n.previewElement.querySelectorAll("[data-dz-name]"))
        e.textContent = n.name;
      for (e of n.previewElement.querySelectorAll("[data-dz-size]"))
        e.innerHTML = this.filesize(n.size);
      ...
      let t = (i) => (
        i.preventDefault(),
        i.stopPropagation(),
        n.status === a.UPLOADING
          ? a.confirm(this.options.dictCancelUploadConfirmation, () =>
              this.removeFile(n)
            )
          : this.options.dictRemoveFileConfirmation
          ? a.confirm(this.options.dictRemoveFileConfirmation, () =>
              this.removeFile(n)
            )
          : this.removeFile(n)
      );
      for (let i of n.previewElement.querySelectorAll("[data-dz-remove]"))
        i.addEventListener("click", t);
    }
  },
  removedfile(n) {
    return (
      n.previewElement != null &&
        n.previewElement.parentNode != null &&
        n.previewElement.parentNode.removeChild(n.previewElement),
  ...
  error(n, e) {
    if (n.previewElement) {
      n.previewElement.classList.add("dz-error"),
        typeof e != "string" && e.error && (e = e.error);
      for (let t of n.previewElement.querySelectorAll("[data-dz-errormessage]"))
        t.textContent = e;
    }
  },
  errormultiple() {},
  processing(n) {
    if (
      n.previewElement &&
      (n.previewElement.classList.add("dz-processing"), n._removeLink)
    )
  ...
  uploadprogress(n, e, t) {
    if (n.previewElement)
      for (let i of n.previewElement.querySelectorAll(
        "[data-dz-uploadprogress]"
      ))
        i.nodeName === "PROGRESS" ? (i.value = e) : (i.style.width = `${e}%`);
  },
  totaluploadprogress() {},
  sending() {},
  sendingmultiple() {},
  ...
  complete(n) {
    if (
      (n._removeLink && (n._removeLink.innerHTML = this.options.dictRemoveFile),
      n.previewElement)
    )
...
class a extends v {
  ...
  getFilesWithStatus(e) {
    return this.files.filter((t) => t.status === e).map((t) => t);
  }
  getQueuedFiles() {
  ...
  getActiveFiles() {
    return this.files
      .filter((e) => e.status === a.UPLOADING || e.status === a.QUEUED)
      .map((e) => e);
  }
  init() {
    if (
    ...
    this.on("uploadprogress", () => this.updateTotalUploadProgress()),
      ...
      this.on("canceled", (i) => this.emit("complete", i)),
      this.on("complete", (i) => {
        if (
    ...
    return (
      ...
      this.clickableElements.forEach((i) =>
        this.listeners.push({
          element: i,
          events: {
            click: (s) => (
              (i !== this.element ||
                s.target === this.element ||
                a.elementInside(
                  s.target,
                  this.element.querySelector(".dz-message")
                )) &&
  ...
  getExistingFallback() {
    let e = function (i) {
      for (let s of i) if (/(^| )fallback($| )/.test(s.className)) return s;
    };
  ...
  filesize(e) {
    ...
    if (e > 0) {
      ...
      for (let l = 0; l < s.length; l++) {
        let r = s[l],
          o = Math.pow(this.options.filesizeBase, 4 - l) / 10;
        if (e >= o) {
  ...
  drop(e) {
    ...
    if (t.length) {
      ...
      i && i.length && i[0].webkitGetAsEntry != null
  ...
  paste(e) {
    if (U(e != null ? e.clipboardData : void 0, (i) => i.items) == null) return;
    this.emit("paste", e);
  ...
  _addFilesFromItems(e) {
    return (() => {
      ...
      for (let s of e) {
        var i;
        s.webkitGetAsEntry != null && (i = s.webkitGetAsEntry())
          ? i.isFile
            ? t.push(this.addFile(s.getAsFile()))
            : i.isDirectory
            ? t.push(this._addFilesFromDirectory(i, i.name))
            : t.push(void 0)
          : s.getAsFile != null && (s.kind == null || s.kind === "file")
          ? t.push(this.addFile(s.getAsFile()))
          : t.push(void 0);
      }
      return t;
        ...
        if (r.length > 0) {
          for (let o of r)
            o.isFile
              ...
              : o.isDirectory &&
                this._addFilesFromDirectory(o, `${t}/${o.name}`);
          l();
        }
        return null;
      }, s);
  ...
  accept(e, t) {
    this.options.maxFilesize && e.size > this.options.maxFilesize * 1048576
      ...
      : a.isValidFile(e, this.options.acceptedFiles)
  ...
  enqueueFile(e) {
    if (e.status === a.ADDED && e.accepted === !0) {
      if (((e.status = a.QUEUED), this.options.autoProcessQueue))
  ...
  removeFile(e) {
    if (
      (e.status === a.UPLOADING && this.cancelUpload(e),
  ...
  resizeImage(e, t, i, s, l) {
    return this.createThumbnail(e, t, i, s, !0, (r, o) => {
      if (o == null) return l(e);
      {
        ...
        return (
          (u === "image/jpeg" || u === "image/jpg") &&
            (d = E.restore(e.dataURL, d)),
          l(a.dataURItoBlob(d))
        );
      }
    });
      ...
      (u.onload = () => {
        ...
        return (
          typeof EXIF < "u" &&
            ...
            l &&
            (d = (h) =>
              EXIF.getData(u, function () {
                return h(EXIF.getTag(this, "Orientation"));
              })),
          d((h) => {
            (e.width = u.width), (e.height = u.height);
            let p = this.options.resize.call(this, e, t, i, s),
              c = document.createElement("canvas"),
              m = c.getContext("2d");
            switch (
              ((c.width = p.trgWidth),
              (c.height = p.trgHeight),
              h > 4 && ((c.width = p.trgHeight), (c.height = p.trgWidth)),
              h)
            ) {
              case 2:
            ...
            A(
              m,
              u,
              p.srcX != null ? p.srcX : 0,
              p.srcY != null ? p.srcY : 0,
              p.srcWidth,
              p.srcHeight,
              p.trgX != null ? p.trgX : 0,
              p.trgY != null ? p.trgY : 0,
              p.trgWidth,
              p.trgHeight
            );
  ...
  _getFilesWithXhr(e) {
    return this.files.filter((t) => t.xhr === e).map((t) => t);
  }
  cancelUpload(e) {
    if (e.status === a.UPLOADING) {
      ...
      (e.status === a.ADDED || e.status === a.QUEUED) &&
        ((e.status = a.CANCELED),
    ...
    this._transformFiles(e, (t) => {
      ...
      if (e[0].upload.chunked) {
        ...
        let l = () => {
          ...
          let o = r * this.options.chunkSize,
            u = Math.min(o + this.options.chunkSize, s.size),
            d = {
        ...
        if (
          ((i.upload.finishedChunkUpload = (r, o) => {
            let u = !0;
            (r.status = a.SUCCESS),
              (r.dataBlock = null),
          ...
          for (let r = 0; r < i.upload.totalChunkCount; r++) l();
        else l();
      } else {
        let i = [];
  ...
  _getChunk(e, t) {
    for (let i = 0; i < e.upload.totalChunkCount; i++)
      if (e.upload.chunks[i] !== void 0 && e.upload.chunks[i].xhr === t)
  ...
  _uploadData(e, t) {
    ...
    let s = this.resolveOption(this.options.method, e, t),
      l = this.resolveOption(this.options.url, e, t);
    i.open(s, l, !0),
    ...
    let u = this.options.defaultHeaders
      ...
      : {};
    this.options.binaryBody && (u["Content-Type"] = e[0].type),
      this.options.headers && f(u, this.options.headers);
    for (let d in u) {
      let h = u[d];
    ...
    if (this.options.binaryBody) {
      ...
      this.options.uploadMultiple && this.emit("sendingmultiple", e, i, d),
      ...
      for (let t of this.element.querySelectorAll(
        ...
        if ((s && (s = s.toLowerCase()), !(typeof i > "u" || i === null)))
          if (t.tagName === "SELECT" && t.hasAttribute("multiple"))
            ...
            (!s || (s !== "checkbox" && s !== "radio") || t.checked) &&
              e.append(i, t.value);
      }
  }
  _updateFilesUploadProgress(e, t, i) {
    if (e[0].upload.chunked) {
      ...
      i
        ...
        : ((l.progress = 100), (l.bytesSent = l.total)),
        (s.upload.progress = 0),
        (s.upload.total = 0),
        (s.upload.bytesSent = 0);
      for (let r = 0; r < s.upload.totalChunkCount; r++)
        s.upload.chunks[r] &&
          typeof s.upload.chunks[r].progress < "u" &&
          ((s.upload.progress += s.upload.chunks[r].progress),
          (s.upload.total += s.upload.chunks[r].total),
          (s.upload.bytesSent += s.upload.chunks[r].bytesSent));
      ...
      for (let s of e)
        (s.upload.total &&
          ...
          (i
            ? ((s.upload.progress = (100 * i.loaded) / i.total),
              (s.upload.total = i.total),
              (s.upload.bytesSent = i.loaded))
  ...
  constructor(e, t) {
    ...
    this.options.acceptedMimeTypes &&
      ...
      this.options.renameFilename != null &&
        (this.options.renameFile = (r) =>
          this.options.renameFilename.call(this, r.name, r)),
      ...
      this.options.previewsContainer !== !1 &&
        (this.options.previewsContainer
          ? (this.previewsContainer = a.getElement(
              this.options.previewsContainer,
              "previewsContainer"
            ))
      ...
      this.options.clickable &&
        (this.options.clickable === !0
          ...
          : (this.clickableElements = a.getElements(
              this.options.clickable,
              "clickable"
            ))),
      this.init();
...
a.optionsForElement = function (n) {
  if (n.getAttribute("id")) return a.options[L(n.getAttribute("id"))];
};
a.instances = [];
a.forElement = function (n) {
  if (
    (typeof n == "string" && (n = document.querySelector(n)),
    (n != null ? n.dropzone : void 0) == null)
  )
    throw new Error(
...
a.isBrowserSupported = function () {
  ...
  if (
    ...
    if (!("classList" in document.createElement("a"))) n = !1;
      ...
      a.blacklistedBrowsers !== void 0 &&
        (a.blockedBrowsers = a.blacklistedBrowsers);
      for (let e of a.blockedBrowsers)
...
a.dataURItoBlob = function (n) {
  let e = atob(n.split(",")[1]),
    t = n.split(",")[0].split(":")[1].split(";")[0],
    i = new ArrayBuffer(e.length),
    s = new Uint8Array(i);
  for (let l = 0, r = e.length, o = 0 <= r; o ? l <= r : l >= r; o ? l++ : l--)
    s[l] = e.charCodeAt(l);
  return new Blob([i], { type: t });
};
const S = (n, e) => n.filter((t) => t !== e).map((t) => t),
  L = (n) => n.replace(/[\-_](\w)/g, (e) => e.charAt(1).toUpperCase());
  ...
  for (let s of e)
    if (((s = s.trim()), s.charAt(0) === ".")) {
      if (
        n.name
          .toLowerCase()
          .indexOf(s.toLowerCase(), n.name.length - s.length) !== -1
      )
        return !0;
    } else if (/\/\*$/.test(s)) {
...
let x = function (n) {
  ...
  i.drawImage(n, 0, 0);
  let { data: s } = i.getImageData(1, 0, 1, e),
    l = 0,
    r = e,
    o = e;
  for (; o > l; )
...
var A = function (n, e, t, i, s, l, r, o, u, d) {
  let h = x(e);
...
Expect errors in decoding.`),
      ...
      (l = this.KEY_STR.indexOf(e.charAt(d++))),
        (r = this.KEY_STR.indexOf(e.charAt(d++))),
        (o = this.KEY_STR.indexOf(e.charAt(d++))),
        (u = this.KEY_STR.indexOf(e.charAt(d++))),
        (t = (l << 2) | (r >> 4)),
        (i = ((r & 15) << 4) | (o >> 2)),
        (s = ((o & 3) << 6) | u),
        h.push(t),
...
k("#datepicker-basic", { defaultDate: new Date() });
a.discover();
